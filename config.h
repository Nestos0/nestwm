...
static const char *fonts[]               = { "FiraCode Nerd Font:style=medium:size=13", "monospace:size=13" };
...
static const unsigned int alphas[][3]    = {          /* 透明度设置 ColFg, ColBg, ColBorder */ 
    ...
    [SchemeBarEmpty] = { 0x00, 0x11, 0x00 },
    [SchemeStatusText] = { OPAQUE, 0x88, 0x00 },
};
...
static const char *tags[] = { 
    ...
    "󰇩", // tag:5  key:c  desc:chrome
    "", // tag:6  key:m  desc:music
    "", // tag:7  key:0  desc:qq
    "", // tag:8  key:w  desc:wechat
    "󰂫", // tag:9  key:l  desc:wxwork
};
...
static const Rule rules[] = {
    ...
    { NULL,                  NULL,                "pentablet",        0,            1,          0,          0,        -1,      0}, // 微信图片查看器      浮动
    ...
    {"Nemo",              NULL,                 NULL,             0,            1,          0,          1,        -1,      3}, //  nemo            浮动、无边框 右上角
    {"nemo",              NULL,                 NULL,             0,            1,          0,          1,        -1,      3}, //  nemo            浮动、无边框 右上角
...
static Key keys[] = {
    ...
    { MODKEY,              XK_h,            hidewin,          {0} },                     /* super i            |  隐藏 窗口 */
    { MODKEY|ShiftMask,    XK_h,            restorewin,       {0} },                     /* super shift i      |  取消隐藏 窗口 */
    ...
    { MODKEY,              XK_l,            toggleborder,     {0} },                     /* super u            |  开启/关闭 边框 */
    { MODKEY|ShiftMask,              XK_e,            incnmaster,       {.i = +1} },               /* super shift e            |  改变主工作区窗口数量 (1 2中切换) */
    ...
    { MODKEY|ControlMask,  XK_u,           movewin,          {.ui = UP} },              /* super ctrl up      |  移动窗口 */
    { MODKEY|ControlMask,  XK_e,         movewin,          {.ui = DOWN} },            /* super ctrl down    |  移动窗口 */
    { MODKEY|ControlMask,  XK_n,         movewin,          {.ui = LEFT} },            /* super ctrl left    |  移动窗口 */
    { MODKEY|ControlMask,  XK_i,        movewin,          {.ui = RIGHT} },           /* super ctrl right   |  移动窗口 */
    ...
    { MODKEY|Mod1Mask,     XK_u,           resizewin,        {.ui = V_REDUCE} },        /* super alt up       |  调整窗口 */
    { MODKEY|Mod1Mask,     XK_e,         resizewin,        {.ui = V_EXPAND} },        /* super alt down     |  调整窗口 */
    { MODKEY|Mod1Mask,     XK_n,         resizewin,        {.ui = H_REDUCE} },        /* super alt left     |  调整窗口 */
    { MODKEY|Mod1Mask,     XK_i,        resizewin,        {.ui = H_EXPAND} },        /* super alt right    |  调整窗口 */

  	{ MODKEY,              XK_u,            focusdir,         {.i = UP } },              /* super k            | 二维聚焦窗口 */
  	{ MODKEY,              XK_e,            focusdir,         {.i = DOWN } },            /* super j            | 二维聚焦窗口 */
  	{ MODKEY,              XK_n,            focusdir,         {.i = LEFT } },            /* super h            | 二维聚焦窗口 */
  	{ MODKEY,              XK_i,            focusdir,         {.i = RIGHT } },           /* super l            | 二维聚焦窗口 */
    { MODKEY|ShiftMask,    XK_u,            exchange_client,  {.i = UP } },              /* super shift k      | 二维交换窗口 (仅平铺) */
    { MODKEY|ShiftMask,    XK_e,            exchange_client,  {.i = DOWN } },            /* super shift j      | 二维交换窗口 (仅平铺) */
    { MODKEY|ShiftMask,    XK_n,            exchange_client,  {.i = LEFT} },             /* super shift h      | 二维交换窗口 (仅平铺) */
    { MODKEY|ShiftMask,    XK_i,            exchange_client,  {.i = RIGHT } },           /* super shift l      | 二维交换窗口 (仅平铺) */
    ...
    { MODKEY,              XK_Return,  spawn, SHCMD("kitty --class float") },                                            /* super space      | 打开浮动st终端         */
    { MODKEY,              XK_space,  spawn, SHCMD("$DWM/xmod.sh") },                                            /* super space      | 打开浮动st终端         */
    { MODKEY,              XK_F1,     spawn, SHCMD("killall nemo || nemo") },                             /* super F1         | 打开/关闭nemo       */
    { MODKEY,              XK_d,      spawn, SHCMD("$DWM/DEF/rofi.sh") },                                         /* super d          | rofi: 执行run          */
    { MODKEY,              XK_p,      spawn, SHCMD("~/.config/rofi/bin/launcher") },                                       /* super p          | rofi: 执行自定义脚本   */
    { MODKEY,              XK_k,      spawn, SHCMD("$DWM/DEF/blurlock.sh") },                                   /* super n          | 锁定屏幕               */
    ...
    { 0,    XF86XK_AudioRaiseVolume,     spawn, SHCMD("$DWM/DEF/set_vol.sh up") },                                 /* super shift up   | 音量加                 */
    { 0,    XF86XK_AudioLowerVolume,   spawn, SHCMD("$DWM/DEF/set_vol.sh down") },                               /* super shift down | 音量减                 */
    ...
    TAGKEYS(XK_m, 5, "/opt/YesPlayMusic/yesplaymusic")
    TAGKEYS(XK_0, 6, "linuxqq")
    TAGKEYS(XK_w, 7, "krita")
    TAGKEYS(XK_y, 8, "blender-3.6")
};
...
static Button buttons[] = {
    ...
    { ClkStatusText,       0,               Button5,          clickstatusbar,{0} },                                   // 鼠标滚轮下  |  状态栏       |  根据状态栏的信号执行 ~/scripts/dwmstatusbar.sh $signal D
                                                                                                                      //
    /* 点击bar空白处 */
    { ClkBarEmpty,         0,               Button1,          spawn, SHCMD("rofi -show window -theme ~/.config/rofi/config/launcher.rasi") },        // 左键        |  bar空白处    |  rofi 执行 window
    { ClkBarEmpty,         0,               Button3,          spawn, SHCMD("~/.config/rofi/bin/launcher") },          // 右键        |  bar空白处    |  rofi 执行 drun
};
